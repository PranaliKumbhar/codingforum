...
<div class="container-fluid">
  <a class="navbar-brand" href="/codingforum">VDiscuss</a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
      ...
      <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle" href="/codingforum" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
          Top 3 Categories
        </a>
    ...
    if(isset($_SESSION['loggedin']) && ($_SESSION['loggedin']==true)){
     echo'<form class="d-flex" action="search.php" method="get">
      ...
      <a href="partials/_logout.php" class="btn btn-outline-success mx-2" type="button">Logout</a>
      </from>
      ';
      }
  else {
   echo'<form class="d-flex" action="search.php" method="get">
        ...
        <button class="btn btn-outline-success ml-2" type="button" data-bs-toggle="modal" data-bs-target="#signupModal">SignUp</button>
        </form>';
      }
